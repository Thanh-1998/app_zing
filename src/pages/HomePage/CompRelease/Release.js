...
function Release() {
  ...
  const { isLoadingPage, data } = useSelector(state => state.releaseReducer);

  return (
    <StyledRelease>
      <h3 className="title-section title title-2 title-tab">
        Mới Phát Hành
      ...
      <div className="select-tab">
        <button className="btn-tab tab-selected">tất cả</button>
